...
- In-game `L + R + START + SELECT` return to Pico Launcher for retail games, with a `<rom>.state.bin` snapshot containing RAM, WRAM, VRAM, ARM9 ITCM, CPU context, palette/OAM, and partial display/DMA/audio/TCM-control state
