...
- In-game `L + R + START + SELECT` return to Pico Launcher for retail games, with a `<rom>.state.bin` snapshot containing RAM, WRAM, VRAM, CPU context, palette/OAM, and partial display/DMA/audio state
